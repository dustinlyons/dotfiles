...
#+CONSTANTS: roam_dir_path="~/Projects/Writing/Roam"
...
** Roam
#+NAME::org-mode-variable-width-fonts
#+BEGIN_SRC emacs-lisp roam_dir_path=(org-table-get-constant "roam_dir_path")
(use-package org-roam
  :disabled t ;; Unitl I finish org-mode understanding, this stays off
  :hook
  (after-init . org-roam-mode)
  :custom
  (org-roam-directory roam_dir_path)
