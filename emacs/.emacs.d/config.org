...
* Configuration   :emacs:
** About this file
This is my emacs config file. Yes, in emacs you can write configuration like a Google Doc and get away with it. It's called "literate programming".
...
**** Helpful UI related packages
These are generally helpful in providing additional information when needed, or otherwise making me more efficeient.
